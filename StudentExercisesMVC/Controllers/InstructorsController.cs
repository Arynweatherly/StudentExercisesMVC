    ...
    public class InstructorsController : Controller
    {
        ...
        public ActionResult Create(Instructor instructor)
        {
            try
            {
                using (SqlConnection conn = Connection)
                {
                    ...
                    using (SqlCommand cmd = conn.CreateCommand())
                    {
                        cmd.CommandText = @"INSERT INTO Instructor (FirstName, LastName, Speciality, CohortId, SlackHandle) VALUES (@firstName, @lastName, @speciality, @cohortId, @slackHandle)";
        ...
        public ActionResult Edit(int id)
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @"SELECT Id, FirstName, LastName, CohortId, Speciality, SlackHandle
                                        FROM Instructor 
                                        WHERE Id = @id";
        ...
        public ActionResult Delete(int id)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @"SELECT FirstName, LastName, SlackHandle, Speciality, CohortId, FROM Instructor WHERE Id = @id";
                    cmd.Parameters.Add(new SqlParameter("@id", id));
